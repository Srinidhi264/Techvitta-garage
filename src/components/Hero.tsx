...
const Hero: React.FC = () => {
  return (
        <section id="portfolio" className="relative min-h-screen flex items-center px-6 lg:px-12 overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="max-w-4xl">
          ...
          >
            <div className="inline-block">
              ...
              <h1 className="text-7xl lg:text-9xl font-black text-gray-900 leading-none" style={{ textDecoration: 'none' }}>
                TechVitta
                <span className="block text-6xl lg:text-8xl text-blue-600 mt-2">Garage</span>
              </h1>
            </div>
          </motion.div>
          ...
          >
            <button className="px-8 py-4 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
              Explore Projects
            </button>
            <button className="px-8 py-4 border-2 border-gray-300 text-gray-700 font-semibold rounded-lg hover:border-blue-600 hover:text-blue-600 transition-all duration-300 transform hover:scale-105">
              Learn More
            </button>
          </motion.div>
        </div>
